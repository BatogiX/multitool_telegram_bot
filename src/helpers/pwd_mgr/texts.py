...
ASK_MASTER_PASSW_TEXT = "Please enter your Master Password"
CREATE_PASSW_TEXT = "Please enter your <Master Password> <login> <password>"
...
UPDATE_CREDENTIALS_TEXT = "Please enter your <Master Password> <login> <password> <new login> <new password>"
CHANGE_MASTER_PASSW_TEXT = "Please enter your <current Master Password> <new Master Password>"
...
PASSW_DELETED_TEXT = "Password was deleted successfully\n\n"
...
def gen_passwords_text(service: str, pwds_offset: int) -> str:
    service = add_protocol(service)
    return SERVICE_TEXT + service + "\n\nChoose your login to see password" + f"\nPage: {pwds_offset + 1}"
